export const questions = [
  {
    ...
    choices: [
      { text: '파티 스텝은 자신이 없다..<br>(그래도 파티는 재밌겠다)', value: 'i' },
      { text: '재밌겠다!<br>동료한테 같이 지원하자고 해야지~', value: 'e' }
    ]
  },
  {
    number: '02',
    ...
    choices: [
      ...
      { text: '다 챙겼겠지?<br>(아직도 챙기는 중)', value: 'n' }
    ]
  },
  {
    number: '03',
    question: '친했던 동기가<br>퇴사를 한다면?',
    choices: [
  ...
  {
    number: '04',
    question: '대규모 프로젝트를 맡게 된후 제일 먼저 하는 것은?',
    choices: [
  ...
  {
    number: '06',
    question: '밖에 날씨가 너무 좋다<br>이럴 때 나는?',
    choices: [
  ...
  {
    number: '07',
    question: '상사한테 혼이 났다.<br>이럴 때 나는?',
    choices: [
  ...
  {
    number: '08',
    question: '일을 하는 데 너무 어려워<br>어떻게 해결하지?',
    choices: [
